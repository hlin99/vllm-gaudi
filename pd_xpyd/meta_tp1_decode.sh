...
bash "$BASH_DIR"/disaggregated_prefill_server_launcher.sh -r decode -m /mnt/disk2/hf_models/Meta-Llama-3-8B-Instruct/ -n 1 -t 1 --node-ip 192.168.100.221 --max-model-len 2048 --max-num-batched-tokens 2048 --max-num-seqs 1 --nixl-buffer-device hpu --log-dir /workspace --gpu-memory-utilization 0.5 --apc --kv-connector lmcache --recipe-cache --no-ep
