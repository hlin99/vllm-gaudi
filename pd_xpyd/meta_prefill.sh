...
source "$BASH_DIR"/disaggregated_prefill_server_launcher.sh -m /mnt/disk2/hf_models/Meta-Llama-3-8B-Instruct/ -n 1 -t 1 --node-ip 192.168.100.191 --max-model-len 2048 --max-num-batched-tokens 2048 --max-num-seqs 1 --nixl-buffer-device hpu --log-dir /workspace --gpu-memory-utilization 0.5 --kv-connector lmcache --recipe-cache --no-ep 
