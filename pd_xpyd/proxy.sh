...
python "$BASH_DIR"/proxy_server.py --port 8868 -m /mnt/disk2/hf_models/DeepSeek-R1-G2/ -p 192.168.100.191:8300 -d 192.168.100.221:9300-9307 192.168.100.231:9308-9315 --bypass-proxy --lmcache_nixl
