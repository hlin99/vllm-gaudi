...
async def lifespan(app: FastAPI):
    ...
    print("global_args.prefiller_host, global_args.prefiller_port=",global_args.prefiller_host, global_args.prefiller_port)
    ...
    print("prefill_pairs=", prefill_pairs)
